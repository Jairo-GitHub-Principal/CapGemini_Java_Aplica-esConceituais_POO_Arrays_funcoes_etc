...
public class DataSimpleDateFormat {
	...
	public static void main(String[] args) throws ParseException {// throws ParseException é nescessario para o parse de sdf_format1 e sdf_format2
		...
		System.out.println("--------------------------------------------------------------------");
		System.out.println("x1: "+sdf_Formato2.format(x1));
		System.out.println("x2: "+sdf_Formato2.format(x2));
		System.out.println("x3: "+sdf_Formato2.format(x3));
		System.out.println("x4: "+sdf_Formato2.format(x4));
		System.out.println("y1: "+sdf_Formato2.format(y1));
		System.out.println("y2: "+sdf_Formato2.format(y2));
		System.out.println("y3: "+sdf_Formato2.format(y3));
		
		System.out.println("--------------------------------------------------------------------");
		System.out.println("x1: "+sdf_Formato3.format(x1));
		System.out.println("x2: "+sdf_Formato3.format(x2));
		System.out.println("x3: "+sdf_Formato3.format(x3));
		System.out.println("x4: "+sdf_Formato3.format(x4));
		System.out.println("y1: "+sdf_Formato3.format(y1));
		System.out.println("y2: "+sdf_Formato3.format(y2));
		System.out.println("y3: "+sdf_Formato3.format(y3));
		
		System.out.println("--------------------------------------------------------------------");
		System.out.println("x1: "+sdf_Formato1.format(x1));
		System.out.println("x2: "+sdf_Formato1.format(x2));
		System.out.println("x3: "+sdf_Formato1.format(x3));
		System.out.println("x4: "+sdf_Formato1.format(x4));
		System.out.println("y1: "+sdf_Formato1.format(y1));
		System.out.println("y2: "+sdf_Formato1.format(y2));
		System.out.println("y3: "+sdf_Formato1.format(y3));
