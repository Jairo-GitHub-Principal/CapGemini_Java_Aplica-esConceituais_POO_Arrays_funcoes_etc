...
public class entradaDeDados {
	...
	public static void main(String[] args) {
		...
		String idadeUser = JOptionPane.showInputDialog("Args, nada mais é que o argumento que vc pede pro usuario passar aqui dentro, nesse caso (idade 1)"); // args ou null funciona igual
		String idadeUser2 = JOptionPane.showInputDialog("Args aqui é a idade 2");
		...
		System.out.println("Cliente nome: "+nome+"e, ID: "+id);
